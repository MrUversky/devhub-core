...
the repository's security-reporting channel described in `SECURITY.md`. State
clearly that the report concerns the Code of Conduct. Reports are reviewed by
the repository maintainers and kept confidential to the extent practical.
